...
蒙特卡洛方法，也成为统计模拟方法，指一类通过重复采样来计算数值结果的算法。
...
上面的3个条件，第一个和第二个是非常难以满足的。所幸的是，我们知道大数定理：
...
这个问题使用蒙特卡洛方法是比较简单的，可以总结成下面的图： ![](../images/exam1-sinint.png)
...
![](E:/R/Learning/MCMC/MonteCarlo_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](E:/R/Learning/MCMC/MonteCarlo_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](E:/R/Learning/MCMC/MonteCarlo_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](E:/R/Learning/MCMC/MonteCarlo_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](E:/R/Learning/MCMC/MonteCarlo_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](E:/R/Learning/MCMC/MonteCarlo_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](E:/R/Learning/MCMC/MonteCarlo_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
